...
public abstract class Character : MonoBehaviour {
	...
	protected virtual void OnEnable() {
		InitializationSequence.InitializePlayer += Initialize;
	}
	...
	[SerializeField] protected float maxSpeed, moveForce, jumpForce, wallJumpForce;
	protected float maxSpeedInitial;
	
	protected bool facingRight = true, grounded = false;
